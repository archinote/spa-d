//import objectAssign from 'element-ui/src/utils/merge'; replace on {...}
...
export default class Node {
  ...
  insertChild(child, index, batch) {
    ...
    if (!(child instanceof Node)) {
      ...
      // @DMSFIX
      child = Object.assign(child,{parent: this, store: this.store}) //{...child,...{parent: this, store: this.store}}
     /* objectAssign(child, {
        parent: this,
        store: this.store
      });*/
