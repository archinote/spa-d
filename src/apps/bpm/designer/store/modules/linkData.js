import apiLinkData from '../../api/link/linkData'
...
const mutations = {
  ...
  //     // console.log("Link Data Store, 'list' mutation, state.items:")
...
const actions = {
  getLinkData({ commit, getters }, { processId, linkId }) {
    return new Promise( (resolve, reject) => {
      apiLinkData.getLinkData( processId, linkId ).then(data => {
        // console.log("Link Data Store, 'getLinkData' action, API response:")
        // console.log(data)
  ...
  sharedPorts({ commit, getters }, { processId, linkId, data }) {
    return new Promise( (resolve, reject) => {
      apiLinkData.sharedPorts( processId, linkId, data ).then(response => {
        // console.log("Link Data Store, 'sharedPorts' action, API response:")
  ...
  linkDataSettings({ commit, getters }, { processId, linkId, data }) {
    return new Promise( (resolve, reject) => {
      apiLinkData.linkDataSettings( processId, linkId, data ).then(response => {
        // console.log("Link Data Store, 'linkDataSettings' action, API response:")
        // console.log(response)
  ...
  //       resolve( _items )
  //     } else {
  //       apiLinkData.list( parentId ).then(list => {
  //         // console.log("Link Data Store, 'list' action, API response:")
  //         // console.log(list)
  //
  ...
  //       apiLinkData.item(parentId, id).then(_item => {
  //         console.log("Link Data Store, 'item' action, API response:")
  //         console.log(_item)
  //
  ...
  //     apiLinkData.create( parentId, item ).then(item => {
  //       // console.log("Link Data Store, 'create' action, API response:")
  //       // console.log(item)
  //
  ...
  //   return new Promise( (resolve, reject) => {
  //     // Try to send data on the server.
  //     apiLinkData.update( parentId, id, item ).then(response => {
  //       // console.log("Link Data Store, 'update' action, API response:")
  //       // console.log(response)
  //
  //       // Update item in the Store
  ...
  //   return new Promise( (resolve, reject) => {
  //     // Try to send data on the server.
  //     apiLinkData.delete( parentId, id ).then(response => {
  //       // console.log("Link Data Store, 'delete' action, API response:")
  //       // console.log(response)
  //
  //       // Update item in the Store
